...
const menuItems = [
  { id: 1, name: 'Masala Dosa', price: 40, category: 'Breakfast', emoji: '🫓' },
  { id: 2, name: 'Idli Sambar', price: 30, category: 'Breakfast', emoji: '🍱' },
  { id: 3, name: 'Veg Fried Rice', price: 60, category: 'Lunch', emoji: '🍚' },
  { id: 4, name: 'Chapati + Curry', price: 50, category: 'Lunch', emoji: '🫓' },
  { id: 5, name: 'Chicken Biryani', price: 90, category: 'Lunch', emoji: '🍗' },
  { id: 6, name: 'Veg Noodles', price: 55, category: 'Lunch', emoji: '🍜' },
  { id: 7, name: 'Samosa', price: 15, category: 'Snacks', emoji: '🥟' },
  { id: 8, name: 'Tea', price: 10, category: 'Drinks', emoji: '🍵' },
  { id: 9, name: 'Coffee', price: 15, category: 'Drinks', emoji: '☕' },
  { id: 10, name: 'Fresh Lime Soda', price: 25, category: 'Drinks', emoji: '🥤' },
]
...
const styles = {
  ...
  card: { backgroundColor: 'white', borderRadius: '12px', padding: '16px', textAlign: 'center', boxShadow: '0 2px 8px rgba(0,0,0,0.07)' },
  emoji: { fontSize: '36px', marginBottom: '8px' },
  itemName: { fontWeight: '600', fontSize: '14px', color: '#1a1a2e', marginBottom: '4px' },
  itemCategory: { fontSize: '12px', color: '#888', marginBottom: '6px' },
  itemPrice: { fontSize: '15px', fontWeight: 'bold', color: '#4f46e5', marginBottom: '12px' },
  addBtn: { backgroundColor: '#4f46e5', color: 'white', border: 'none', borderRadius: '8px', padding: '7px 20px', cursor: 'pointer', fontWeight: '600', fontSize: '13px' },
  qtyRow: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '12px' },
  ...
  qtyNum: { fontWeight: 'bold', fontSize: '15px', minWidth: '20px' },
